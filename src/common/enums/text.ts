...
export const TEXT = {
  zh_hant: {
    ...
    publishToISCNHint_2: '用以出版 Writing NFT，費用 ≈1 LIKE，推廣期由平台補助',
    putComment: '發布評論',
  ...
  zh_hans: {
    ...
    publishToISCNHint_2: '用以出版 Writing NFT，费用 ≈1 LIKE，推广期由平台补助',
    putComment: '发布评论',
  ...
  en: {
    ...
    publishToISCN: 'Register for ISCN to publish Writing NFT',
